  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_formKey.currentState.validate()) {
        ...
        if (selectedValue == LocaleKeys.tap.tr()) {
          Autogenerated a = await ApiOrder.instance.makeOrderTapPayment(
            phone: phone,
            email: email,
            city: city,
            address: address,
          ...
          kIsWeb
              ...
              : Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => OrderView(a.transaction.url)));
          return;
        } else {
